...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST['formid'] == 'form2')
{
   ...
   $subject = 'Konsultacija Malchisnik-Devichnik. Perezvonite!';
   $message = 'Konsultacija Malchisnik-Devichnik. Perezvonite!';
...
<link href="mal-dev.css" rel="stylesheet" type="text/css">
...
<input type="tel" id="Editbox4" name="Телефон" value="" required pattern="[ \t\r\n\f0-9-+ ()]*$" placeholder="&#1058;&#1077;&#1083;&#1077;&#1092;&#1086;&#1085;">
<input type="submit" id="Button1" name="" value="УЗНАТЬ БОЛЬШЕ!">
<input type="text" id="Editbox2" name="Имя" value="" required pattern="[A-Za-zÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖØÙÚÛÜÝÞßàáâãäåæçèéêëìíîïðñòóôõöøùúûüýþÿ \t\r\n\f0-9-йцукенгшщзхъфывапролджэячсмитьбюЙЦУКЕНГШЩЗХЪФЫВАПРОЛДЖЭЯЧСМИТЬБЮ-]*$" placeholder="&#1048;&#1084;&#1103;">
<input type="email" id="Editbox1" name="E-mail" value="" required placeholder="E-mail">
<div id="wb_Text19">
<div id="wb_uid0"><span id="wb_uid1"><strong>Пати перед свадьбой </strong></span></div>
<div id="wb_uid2"><span id="wb_uid3"><strong>будет мега-клевой!</strong></span></div>
</div>
</form>
</div>
</div>
