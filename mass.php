...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST['formid'] == 'form2')
{
   ...
   $subject = 'Konsultacija Massovie Prazdniki. Perezvonite!';
   $message = 'Konsultacija Massovie Prazdniki. Perezvonite!';
...
<link href="mass.css" rel="stylesheet" type="text/css">
...
<div id="wb_Text19">
<div id="wb_uid0"><span id="wb_uid1"><strong>Любое мероприятие </strong></span></div>
<div id="wb_uid2"><span id="wb_uid3"><strong>на высшем уровне!</strong></span></div>
</div>
