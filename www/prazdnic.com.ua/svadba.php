...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST['formid'] == 'form2')
{
   ...
   $subject = 'Konsultacija Svadba. Perezvonite!';
   $message = 'Konsultacija Svadba. Perezvonite!';
...
<link href="svadba.css" rel="stylesheet" type="text/css">
...
<div id="wb_Text19">
<div id="wb_uid0"><span id="wb_uid1"><strong>Узнайте как я проведу </strong></span></div>
<div id="wb_uid2"><span id="wb_uid3"><strong>свадьбу Вашей мечты!</strong></span></div>
</div>
</form>
</div>
</div>
