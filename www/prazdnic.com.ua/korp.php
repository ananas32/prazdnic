...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST['formid'] == 'form2')
{
   ...
   $subject = 'Konsultacija Kororativ. Perezvonite!';
   $message = 'Konsultacija Kororativ. Perezvonite!';
...
<link href="korp.css" rel="stylesheet" type="text/css">
...
<div id="wb_Text19">
<div id="wb_uid0"><span id="wb_uid1"><strong>Корпоратив станет</strong></span></div>
<div id="wb_uid2"><span id="wb_uid3"><strong>незабываемым!</strong></span></div>
</div>
