...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST['formid'] == 'form2')
{
   ...
   $subject = 'Konsultacija Klub Vecherinka. Perezvonite!';
   $message = 'Konsultacija Klub Vecherinka. Perezvonite!';
...
<link href="klub.css" rel="stylesheet" type="text/css">
...
<div id="wb_Text19">
<div id="wb_uid0"><span id="wb_uid1"><strong>Клубная вечеринка со </strong></span></div>
<div id="wb_uid2"><span id="wb_uid3"><strong>мной станет горячей!</strong></span></div>
</div>
</form>
</div>
</div>
