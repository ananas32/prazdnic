...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST['formid'] == 'form2')
{
   ...
   $subject = 'Konsultacija Koncert. Perezvonite!';
   $message = 'Konsultacija Koncert. Perezvonite!';
...
<link href="koncert.css" rel="stylesheet" type="text/css">
...
<div id="wb_Text19">
<div id="wb_uid0"><span id="wb_uid1"><strong>Из любого концерта</strong></span></div>
<div id="wb_uid2"><span id="wb_uid3"><strong>сделаю крутое ШОУ!</strong></span></div>
</div>
</form>
</div>
</div>
