...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST['formid'] == 'form2')
{
   ...
   $subject = 'Konsultacija DR. Perezvonite!';
   $message = 'Konsultacija DR. Perezvonite!';
...
<div id="wb_Text19">
<div id="wb_uid0"><span id="wb_uid1"><strong>Ваш день рождения</strong></span></div>
<div id="wb_uid2"><span id="wb_uid3"><strong>будет самым ярким!</strong></span></div>
</div>
</form>
</div>
</div>
